...
onMounted(() => {
  ...
  // 并行执行获取天气、预约数据、场地状态和订阅，数据加载完成后显示页面
  Promise.all([
    fetchWeatherData(),
    fetchBookings(),
    fetchVenueSlots(),
